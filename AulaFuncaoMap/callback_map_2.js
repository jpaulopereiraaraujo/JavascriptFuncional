...
const carrinhoPrint = (fn) => console.log(carrinho.map(fn))

carrinhoPrint(getNome)

carrinhoPrint(getQtde)

carrinhoPrint(getPreco)

carrinhoPrint(getCaracteristicas)

carrinhoPrint(getCor)

carrinhoPrint(getTamanho)

carrinhoPrint(getPeso)

carrinhoPrint(getTotal)